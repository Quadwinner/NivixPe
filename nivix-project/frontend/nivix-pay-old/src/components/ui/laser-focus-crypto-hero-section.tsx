...
export const LaserFlow: React.FC<LaserFlowProps> = ({
  ...
  useEffect(() => {
    ...
    renderer.setClearColor(0x000000, 1) // Remains black for the shader base
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-ink-950 w-full font-body">
      <div className="absolute inset-0 z-0">
        <LaserFlow
          color="#0F9688" // NivixPe Ocean Teal
      ...
      <div className="absolute top-4 left-2 h-40 w-40 rounded-full bg-teal-500/80 blur-[200px]"></div>

      {/* Hero Content */}
      <div className="relative z-10 flex-1 flex flex-col pt-20 pb-16 items-center text-center">
      ...
      <div className="relative z-10 lg:px-0 px-6 pb-20">
        <div className="xl:max-w-7xl max-w-6xl mx-auto w-full">
          <div className="bg-ink-900/90 backdrop-blur-xl rounded-xl border border-ink-700/50 overflow-hidden shadow-elevated">
            {/* Dashboard Header */}
            <div className="flex items-center justify-between p-6 border-b border-ink-800">
              ...
              <div className="flex items-center gap-4">
                <Search className="w-5 h-5 text-ink-400 hover:text-white cursor-pointer" />
                <Bell className="w-5 h-5 text-ink-400 hover:text-white cursor-pointer" />
                <Settings className="w-5 h-5 text-ink-400 hover:text-white cursor-pointer" />
              </div>
            </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex gap-2 text-xs font-mono">
                        ...
                        <button className="text-ink-400 hover:text-white transition-colors">4H</button>
                        <button className="text-ink-400 hover:text-white transition-colors">1D</button>
                        <button className="text-ink-400 hover:text-white transition-colors">1W</button>
                      </div>
                    </div>
                  </div>
      ...
      {/* Gradient Overlay for bottom transition — fades to white */}
      <div className="absolute inset-x-0 bottom-0 h-40 z-[1] pointer-events-none" style={{ background: 'linear-gradient(to top, #FFFFFF, transparent)' }} />
    </section>
  )
}
